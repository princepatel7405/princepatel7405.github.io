  ...
  return (
    <div id="contact" style={{ marginBottom: "50px", paddingTop: "50px" }}>
      ...
      <div className="contact-details">
          <Flex justifyContent={"center"} gap={"2"} _hover={{cursor:"pointer"}} onClick={()=>window.open("mailto:prince.m.7405@gmail.com")}>
        ...
        <Flex justifyContent={"center"} gap="10px">
            <Flex onClick={()=>window.open("https://github.com/princepatel7405")} _hover={{cursor:"pointer"}} >
              <img
                src={
          ...
          <br />
            <Flex onClick={()=>window.open("https://www.linkedin.com/in/prince-mendpara-1384a11b6/")} _hover={{cursor:"pointer"}} >  
              <img
                src={
